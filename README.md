...
A:The biggest difference is that forEach() allows the mutation of the original array, while map() returns a new array of the same size.

2. What is the difference between a function and a method?

A: They are both are functions its just that the method is located inside the object.

3. What is closure?

A: Is a function that can access info outside it's scope.
...
A: To inherent the same traits of a parent.
